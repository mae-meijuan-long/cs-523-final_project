...
import scala.Tuple2;
public class Kafka082stream2HBase{

	 static org.slf4j.Logger logger = LoggerFactory.getLogger(Kafka082stream2HBase.class.getName());
	...
	public static void main(String[] args) throws Exception {
		    ...
		    */
		    ...
		    kafkaParams.put("metadata.broker.list", Constants.KAFKA_BOOTSTRAP_SERVER_VALUE);
		    ...
		    messages.foreachRDD(f->{
		    	 JavaPairRDD<String, List<String>> formattedRdd = f.map(x->x._2).filter(x->x!=null).mapToPair(line->
		    	 {
